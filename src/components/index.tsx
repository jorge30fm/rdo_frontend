...
export { default as AccentBackgroundSection } from "./sections/AccentBackgroundSection";
export { default as FeaturedCollectionsSection } from "./sections/FeaturedCollectionsSection";
export { default as SplitFeatureSection } from "./sections/SplitFeatureSection";
